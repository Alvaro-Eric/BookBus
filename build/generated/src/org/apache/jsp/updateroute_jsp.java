...
public final class updateroute_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <div class=\"px-4 py-2  sm:p-6\">\n");
      out.write("                        <div class=\"grid grid-cols-6 gap-6\">\n");
      out.write("                            <input type=\"number\" name=\"id\" id=\"id\" hidden=\"\" value=\"");
      ...
      out.write("\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("\n");
      out.write("                            <div class=\"col-span-6 sm:col-span-3\">\n");
      out.write("                                <label for=\"destination\" class=\"block text-sm font-medium text-gray-700\">Last name</label>\n");
      out.write("                                <input type=\"text\" name=\"destination\" id=\"destination\" value=\"");
      out.print(route.getDestination());
      out.write("\" class=\"mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-span-6 sm:col-span-6\">\n");
      out.write("                                <label for=\"status\" class=\"block text-sm font-medium text-gray-700\">Journey Status</label>\n");
      out.write("                                <select id=\"status\" name=\"status\" class=\"mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm\">\n");
